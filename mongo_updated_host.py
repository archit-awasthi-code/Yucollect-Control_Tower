...
# MongoDB connection details with updated host
MONGO_DB_NAME = "qa_ihs"
MONGO_DB_USER = "qa_ihs_mongo_svc"
MONGO_DB_PASSWORD = "cwUo8Zzy52CBhUhf"
MONGO_DB_HOST = "pl-0-ap-south-1.ax1ah.mongodb.net"  # Updated host

# Construct the MongoDB URI
MONGO_DB_URI = f"mongodb+srv://{MONGO_DB_USER}:{MONGO_DB_PASSWORD}@{MONGO_DB_HOST}/{MONGO_DB_NAME}"

print(f"Connecting to MongoDB using URI: {MONGO_DB_URI}")
print(f"Using updated host: {MONGO_DB_HOST}")
