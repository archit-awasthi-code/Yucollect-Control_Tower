...
with date_col1:
    start_date = st.date_input("Start Date", value=datetime.now() - timedelta(days=30), key="lob_start_date")
with date_col2:
    end_date = st.date_input("End Date", value=datetime.now(), key="lob_end_date")
